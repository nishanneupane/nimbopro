...
const AuthLayout = ({ children }: { children: React.ReactNode }) => {
    return (
        <div className={`${montserrat.className} min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800`}>
            <div className="w-full max-w-7xl mx-auto px-0 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between">
                <div className="w-full mb-10 md:mb-0 pr-0 md:pr-10">
                ...
                <div className="w-full flex items-end">
                    <div className="bg-gray-800 bg-opacity-80 backdrop-filter backdrop-blur-lg rounded-xl shadow-2xl p-0 sm:p-4 overflow-auto w-full">
                        {children}
                    </div>
                </div>
            </div>
