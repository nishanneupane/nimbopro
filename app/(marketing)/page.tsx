...
// const MarketingPage = () => {
//     return (
//         <div className='flex items-center justify-start flex-col bg-gray-100 min-h-screen'>
//             <div className={cn("flex items-center justify-center flex-col", headingFont.className)}>
//                 <h1 className="text-3xl md:text-6xl text-center text-gray-800 mb-6">
...
//                 </h1>
//             </div>
//             <div className="text-base md:text-lg text-gray-600 mt-4 max-w-md md:max-w-2xl text-center mx-auto">
...
//             </div>
//             <Button className='mt-6 text-white font-bold py-2 px-4 rounded transition duration-300 ease-in-out transform hover:scale-105'>
//                 <Link href={"/sign-up"}>
        ...
        <div className='flex items-center justify-start flex-col bg-gray-100 min-h-screen'>
            ...
            <section className="py-10 w-full">
                <div className="max-w-6xl mx-auto px-4">
                    <h2 className="text-3xl font-bold text-gray-800 mb-6">What you&apos;ll get?</h2>
