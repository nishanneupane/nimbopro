...
const PrivacyPolicyPage = () => {
    return (
        <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <h1 className="text-3xl font-bold mb-8 text-center text-foreground">Privacy Policy for Nimbo Pro</h1>
            <div className="space-y-6 text-muted-foreground">
                <p>Last updated: [Current Date]</p>
                
                <h2 className="text-2xl font-semibold mt-6 text-foreground">1. Introduction</h2>
                ...
                <h2 className="text-2xl font-semibold mt-6 text-foreground">2. Data We Collect</h2>
                ...
                <h2 className="text-2xl font-semibold mt-6 text-foreground">3. How We Use Your Data</h2>
                <p>We use your personal data to provide and improve our services, communicate with you, and comply with legal obligations.</p>
                
                <h2 className="text-2xl font-semibold mt-6 text-foreground">4. Data Security</h2>
                ...
                <h2 className="text-2xl font-semibold mt-6 text-foreground">5. Your Rights</h2>
                ...
                <h2 className="text-2xl font-semibold mt-6 text-foreground">6. Contact Us</h2>
